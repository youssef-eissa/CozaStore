...
return (
    <div className='container-fluid'>
        ...
        <div className='container'>
            <div className='row'>
                <div className='col-12 d-flex flex-column flex-md-row justify-content-between about p-5'>
                    ...
                    <div className='col-md-4 col-12 align-self-start rightBox d-flex justify-content-center'>
                        <div className='col-12 imgBox overflow-hidden'>
                            <img alt='img' className='img-fluid h-100 w-100' src={firstImg}/>
                        </div>
                    </div>
                </div>
                <div className='col-12 d-flex flex-column  justify-content-between flex-row-md-reverse about p-5'>
                    <div className='col-md-6 col-12 d-flex flex-column'>
                        <h2>Our Mission</h2>
                        <p className='col-12'>
                    ...
                    <div className='col-md-4 col-12  align-self-start leftBox d-flex justify-content-center'>
                        <div className='col-12 imgBox overflow-hidden '>
